...
You need either `neofetch` or `fastfetch` to be installed. If you want to use `fastfetch` you must append `-ff` to the command when running anifetch. For neofetch you don't need to add any special arguments. 
